...
@FragmentWithArgs
public class PlatformsFragment extends
        BaseLceFragment<RecyclerView, List<GamePlatformInfoList>, PlatformsView, PlatformsPresenter>
        implements PlatformsView {
    @BindInt(R.integer.grid_columns_count)
    int gridColumnsCount;
    @BindString(R.string.platforms_fragment_title)
    String fragmentTitle;
    @BindString(R.string.msg_no_platforms_found)
    String emptyViewText;
    @BindString(R.string.msg_platforms_start)
    ...
    private PlatformsComponent platformsComponent;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new PlatformsAdapter(platformId -> {
            if (twoPaneMode) {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(R.menu.fragment_platform_list, menu);
    ...
    @NonNull
    @Override
    public PlatformsPresenter createPresenter() {
        return platformsComponent.presenter();
    }

    @Override
    protected void injectDependencies() {

        platformsComponent = GiantBombApp.getAppComponent()
                .plusRemoteComponent(new GameRemoteDataModule())
                .plusPlatformsComponent();
    ...
    @Override
    public List<GamePlatformInfoList> getData() {
        return adapter == null ? null : adapter.getPlatforms();
    }

    @Override
    public void setData(List<GamePlatformInfoList> data) {
        adapter.setPlatforms(data);
    ...
    @NonNull
    @Override
    public LceViewState<List<GamePlatformInfoList>, PlatformsView> createViewState() {
    ...
    public void loadDataByName(String name) {
        presenter.loadPlatformsData(name);
    }
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                if (chosenName.length() > 0) {
                    loadDataByName(chosenName);
                    setTitle(chosenName);
                    presenter.logPlatformSearchEvent(chosenName);
                }
                return false;
            }
